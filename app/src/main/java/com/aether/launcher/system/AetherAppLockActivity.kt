...
class AetherAppLockActivity : ComponentActivity() {
    ...
    private fun render(status:TextView){
        ...
        apps.forEach{app->
            ...
            val row=LinearLayout(this).apply{gravity=Gravity.CENTER_VERTICAL;setPadding(dp(12),dp(7),dp(8),dp(7));background=glass(if(protected)0x824B6E9A else 0x5A101821,22f);setOnClickListener{}}
